...
function Replacements() {
    return (
        ...
        <div>
        <table className='table-container-03'>
            <tr className='table-title-03'>
                <th>Roof sections</th>
                <th>General maintenance</th>
                <th>Addiotional Repairs</th>
                <Link to='/history'>
                    <th className='replacements-03' >Replacements</th>
                </Link>
                <th>History</th>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <th className='text-title-03' ><img src={viewReport} /> View Report</th>
            </tr>
