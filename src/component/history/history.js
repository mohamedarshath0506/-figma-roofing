...
function History() {
    return (
        ...
        <div>
        <table className='table-container-04'>
            <tr className='table-title-04'>
                <th>Roof sections</th>
                <th>General maintenance</th>
                <th>Addiotional Repairs</th>
                <th>Replacements</th>
                <Link to='/review'>
                    <th className='history-04'>History</th>
                </Link>
            </tr>
        </table>
        <div>
            ...
            {/* <tr className='heading-item-03'>
                <td>SERVIES TYPE</td>
                <td>INSPECTION DATE AND TIME</td>
                <td>ACTION</td>
            </tr> */}
            <div>
                <h3>7 Novermber 2022</h3>
                <h3> 7:62pm</h3>
                <h3></h3>
                <h3 className='padding-button'>pending</h3>
            </div>

            <div>
                <h3>5 Novermber 2022</h3>
                <h3> 5:26am</h3>
                <h3><b>Resson:</b><small>A page full of sample addresses for your pasing enjoyment! (All date is random....) Cecilia Chapman 711-2880 Nulla St. Mankato Mississippi 96522</small></h3>
                <th className='button-item-01'>Rejected</th>
            </div>

            <div>
                <th>2 Novermber 2022</th>
                <th> 5:26am</th>
                <th><b>Resson:</b><small>A page full of sample addresses for your pasing enjoyment! (All date is random....) Cecilia Chapman 711-2880 Nulla St. Mankato Mississippi 96522</small></th>
                <th className='button-item-01'>Rejected</th>
            </div>
        </div>
