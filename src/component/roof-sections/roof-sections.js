        ...
        <div>
            ...
            <div>
                <table className='table-container'>
                    ...
                    <Link to="/generalMaintenance ">
                        <th className='roof-section'>Roof sections</th>
                    </Link>
                    ...
                    <tr className="roofs-content">
                        <th>ROOFS</th>
                        <img src={search} />
                    </tr>
                    <tr className='heading-item'>
                        <td>ROOF NAME</td>
                        <td>NUMBER OF ADDITIONAL SERVIES</td>
                    ...
                    <tr>
                        ...
                        <th className='text-title' ><img src={viewReport} /> View Report</th>
                    </tr>
                    <tr>
                        <th>Roof Name</th>
                        <th>00</th>
