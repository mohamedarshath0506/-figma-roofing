...
function GeneralMaintenance() {
    return (
        ...
        <div>
        <table className='table-container-01'>
            <tr className='table-title-01'>
                <th>Roof sections</th>
                <Link to='/addiotionalRepairs'>
                    <th className='general-maintenance-01'>General maintenance</th>
                </Link>
            ...
            <tr>
                ...
                <th className='text-title-01' ><img src={viewReport} /> View Report</th>
            </tr>
